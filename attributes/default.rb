...
when 'mac_os_x', 'mac_os_x_server'
  ...
  default['wkhtmltopdf-update']['checksum'] = '402209589279e092c94d17c76e6fdda6be5cadb21ce12e7c093c41f82b757506'
when 'windows'
  default['wkhtmltopdf-update']['dependency_packages'] = []
  default['wkhtmltopdf-update']['platform'] = if node['kernel']['machine'] == 'x86_64'
                                                'msvc2015-win64.exe'
                                                default['wkhtmltopdf-update']['checksum'] = '14a5996adc77dc606944dbc0dc682bff104cd38cc1bec19253444cb87f259797'
                                              else
                                                'msvc2015-win32.exe'
                                                default['wkhtmltopdf-update']['checksum'] = '6883d1456201bc9d421cb7dd32a99458be3d56631ea4f292e51b3c1aecbe2723'
                                              end
else
  ...
  default['wkhtmltopdf-update']['platform'] = if node['kernel']['machine'] == 'x86_64'
                                                ...
                                                default['wkhtmltopdf-update']['checksum'] = '049b2cdec9a8254f0ef8ac273afaf54f7e25459a273e27189591edc7d7cf29db'
                                              else
                                                'linux-generic-i386.tar.xz'
                                                default['wkhtmltopdf-update']['checksum'] = '4087b264ec860ab0b0f9b7299ef733fc51e8e39f42047a06724b7450016ab9b8'
                                              end
end

default['wkhtmltopdf-update']['archive'] = "wkhtmltox-#{node['wkhtmltopdf-update']['version']}_#{node['wkhtmltopdf-update']['platform']}"
default['wkhtmltopdf-update']['checksum'] = nil
